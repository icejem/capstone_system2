...
use App\Filament\Resources\UserSessions\Pages\ManageUserSessions;
...
class UserSessionResource extends Resource
{
                    ...
                    ->schema([
                        Grid::make(2)
                            ->schema([
                                ...
                                TextInput::make('active_minutes')
                                    ->numeric()
                                    ->minValue(0),
                                TextInput::make('logout_reason')
                                    ->maxLength(255),
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('logout_at')
                    ->dateTime()
                    ->sortable(),
                TextColumn::make('active_minutes')
                    ->numeric()
                    ->suffix(' min')
                    ->sortable(),
            ])
    ...
    {
        return [
            'index' => ManageUserSessions::route('/'),
        ];
    }
}
