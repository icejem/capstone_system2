...
<head>
    ...
    <title>Filtered Consultations Export</title>
    <style>
...
<body>
    <div class="page">
        ...
        <div class="sheet">
            <div class="heading">
                <div>
                    <h1>Filtered Consultations Report</h1>
                    <p>Only the consultations currently matched by the admin filters are included.</p>
                </div>
                <div class="meta">
            ...
            <div class="footer">This export includes only the consultation records selected by the active filters.</div>
        </div>
    </div>
    <script>
