...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .auth-capture-inline{display:flex;align-items:center;gap:8px;}
        ...
        .capture-modal-shell{position:fixed;inset:0;z-index:1550;display:none;align-items:center;justify-content:center;padding:18px;}
        .capture-modal-shell.active{display:flex;}
        .capture-modal-backdrop{position:absolute;inset:0;background:rgba(15,23,42,0.62);backdrop-filter:blur(4px);}
        .capture-modal-card{position:relative;width:min(480px,100%);border-radius:16px;border:1px solid rgba(148,163,184,0.3);background:#0b1834;padding:14px;box-shadow:0 24px 60px rgba(2,10,28,0.6);}
        .capture-modal-head{display:flex;align-items:center;justify-content:space-between;color:#eaf7ff;margin-bottom:10px;}
        .capture-modal-title{font-size:16px;font-weight:800;}
        .capture-modal-close{width:32px;height:32px;border-radius:9px;border:1px solid rgba(148,163,184,0.35);background:rgba(7,24,51,0.8);color:#dff7ff;cursor:pointer;}
        .capture-modal-video{width:100%;height:280px;object-fit:cover;border-radius:12px;border:1px solid rgba(117,203,255,0.3);background:#061127;}
        .capture-modal-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:10px;}
        ...
        .app-loader-face, .app-loader-face-back {
            position: absolute;
            inset: 0;
            border-radius: 50%;
        ...
        .app-loader-face::after, .app-loader-face-back::after {
            content: '';
            position: absolute;
            inset: 0;
            border-radius: 50%;
...
<body>
                ...
                <div class="app-loader-coin">
                    ...
                    <div class="app-loader-face">
                        <svg class="app-loader-logo-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <defs>
                                <clipPath id="welcomeAppLoaderHexClip">
                                    <polygon points="50,4 92,27 92,73 50,96 8,73 8,27"/>
                                </clipPath>
                                <linearGradient id="welcomeAppLoaderMain" x1="0%" y1="0%" x2="100%" y2="100%">
                                    <stop offset="0%" stop-color="#6eb8ff"/>
                                    <stop offset="55%" stop-color="#4a90d9"/>
                                    <stop offset="100%" stop-color="#1a5faa"/>
                                </linearGradient>
                                <radialGradient id="welcomeAppLoaderFill" cx="38%" cy="30%" r="70%">
                                    <stop offset="0%" stop-color="#0e2e5a"/>
                                    <stop offset="100%" stop-color="#071428"/>
                                </radialGradient>
                                <linearGradient id="welcomeAppLoaderShine" x1="0%" y1="0%" x2="60%" y2="100%">
                                    <stop offset="0%" stop-color="rgba(255,255,255,0.14)"/>
                                    <stop offset="100%" stop-color="rgba(255,255,255,0)"/>
                                </linearGradient>
                            </defs>
                            <polygon points="50,4 92,27 92,73 50,96 8,73 8,27" fill="none" stroke="url(#welcomeAppLoaderMain)" stroke-width="2.5" opacity="0.9"/>
                            <polygon points="50,10 87,30.5 87,69.5 50,90 13,69.5 13,30.5" fill="url(#welcomeAppLoaderFill)" clip-path="url(#welcomeAppLoaderHexClip)"/>
                            <polygon points="50,10 87,30.5 87,69.5 50,90 13,69.5 13,30.5" fill="none" stroke="rgba(74,144,217,0.2)" stroke-width="1"/>
                            <polygon points="50,10 87,30.5 87,69.5 50,90 13,69.5 13,30.5" fill="url(#welcomeAppLoaderShine)" opacity="0.6"/>
                            <text x="50" y="63" text-anchor="middle" font-family="'Segoe UI', Arial, sans-serif" font-size="36" font-weight="800" letter-spacing="-1" fill="url(#welcomeAppLoaderMain)">CS</text>
                            <line x1="26" y1="70" x2="74" y2="70" stroke="url(#welcomeAppLoaderMain)" stroke-width="1.5" stroke-linecap="round" opacity="0.6"/>
                            <circle cx="50" cy="18" r="2.5" fill="url(#welcomeAppLoaderMain)" opacity="0.7"/>
                        </svg>
                    </div>
                    <div class="app-loader-face-back">
                        <svg class="app-loader-logo-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="transform:scaleX(-1)" aria-hidden="true">
                            <defs>
                                <linearGradient id="welcomeAppLoaderMainBack" x1="0%" y1="0%" x2="100%" y2="100%">
                                    <stop offset="0%" stop-color="#6eb8ff"/>
                                    <stop offset="55%" stop-color="#4a90d9"/>
                                    <stop offset="100%" stop-color="#1a5faa"/>
                                </linearGradient>
                                <radialGradient id="welcomeAppLoaderFillBack" cx="38%" cy="30%" r="70%">
                                    <stop offset="0%" stop-color="#0e2e5a"/>
                                    <stop offset="100%" stop-color="#071428"/>
                                </radialGradient>
                                <linearGradient id="welcomeAppLoaderShineBack" x1="0%" y1="0%" x2="60%" y2="100%">
                                    <stop offset="0%" stop-color="rgba(255,255,255,0.14)"/>
                                    <stop offset="100%" stop-color="rgba(255,255,255,0)"/>
                                </linearGradient>
                            </defs>
                            <polygon points="50,4 92,27 92,73 50,96 8,73 8,27" fill="none" stroke="url(#welcomeAppLoaderMainBack)" stroke-width="2.5" opacity="0.9"/>
                            <polygon points="50,10 87,30.5 87,69.5 50,90 13,69.5 13,30.5" fill="url(#welcomeAppLoaderFillBack)"/>
                            <polygon points="50,10 87,30.5 87,69.5 50,90 13,69.5 13,30.5" fill="none" stroke="rgba(74,144,217,0.2)" stroke-width="1"/>
                            <polygon points="50,10 87,30.5 87,69.5 50,90 13,69.5 13,30.5" fill="url(#welcomeAppLoaderShineBack)" opacity="0.6"/>
                            <text x="50" y="63" text-anchor="middle" font-family="'Segoe UI', Arial, sans-serif" font-size="36" font-weight="800" letter-spacing="-1" fill="url(#welcomeAppLoaderMainBack)">CS</text>
                            <line x1="26" y1="70" x2="74" y2="70" stroke="url(#welcomeAppLoaderMainBack)" stroke-width="1.5" stroke-linecap="round" opacity="0.6"/>
                            <circle cx="50" cy="18" r="2.5" fill="url(#welcomeAppLoaderMainBack)" opacity="0.7"/>
                        </svg>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-shell" id="authModal" aria-hidden="true">
        ...
        <div class="auth-modal" role="dialog" aria-modal="true" aria-labelledby="authModalTitle">
            ...
            @if(session('status') && in_array(session('auth_form'), ['forgot', 'login', 'register'], true))
            ...
            <section class="auth-panel" id="registerPanel">
                <form method="POST" action="{{ route('register') }}" class="auth-grid-register" novalidate data-live-validate="welcome-register">
                    ...
                    <div>
                        <div class="auth-capture-inline">
                            <label class="auth-label" for="registerPasswordConfirmation" style="margin-bottom:0;">Confirm Password</label>
    ...
    <div class="capture-modal-shell" id="captureModal" aria-hidden="true">
        ...
        <div class="capture-modal-card" role="dialog" aria-modal="true" aria-labelledby="captureModalTitle">
            <div class="capture-modal-head">
                <h3 class="capture-modal-title" id="captureModalTitle">Capture Profile Picture</h3>
                <button type="button" class="capture-modal-close" data-close-capture aria-label="Close capture">&times;</button>
            </div>
            <video class="capture-modal-video" data-camera-video autoplay playsinline muted></video>
            <canvas data-camera-canvas hidden></canvas>
            <div class="capture-modal-actions">
                <button type="button" class="auth-camera-btn" data-capture-photo>Take Picture</button>
            </div>
        </div>
    </div>
    ...
    (function () {
        ...
        if (registerForm) {
            ...
            const cameraCaptureButton = document.querySelector('[data-capture-photo]');
            const captureCloseButtons = Array.from(document.querySelectorAll('[data-close-capture]'));
            ...
            cameraCaptureButton?.addEventListener('click', () => {
                if (captureCurrentFrame()) {
                    if (cameraStartButton) {
                        cameraStartButton.textContent = 'Capture Again';
                    }
                    updateSubmitState();
                }
            });
            captureCloseButtons.forEach((button) => {
                button.addEventListener('click', closeCaptureModal);
            });
            document.addEventListener('keydown', (event) => {
                if (event.key === 'Escape' && captureModal?.classList.contains('active')) {
                    closeCaptureModal();
                }
            });
            if (captureModal) {
        ...
        if (hasRegisterErrors) {
            ...
            showPanel('login');
        } else if (Boolean(@json(session('status'))) && (flashAuthForm === 'forgot' || flashAuthForm === 'login' || flashAuthForm === 'register')) {
            showPanel(flashAuthForm === 'register' ? 'login' : flashAuthForm);
