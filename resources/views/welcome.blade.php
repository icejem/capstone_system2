    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .feature-card {
            ...
            text-align: center;
            border: 1px solid rgba(162, 221, 255, 0.18);
            background: linear-gradient(180deg, rgba(100, 167, 223, 0.95), rgba(50, 112, 172, 0.96));
            box-shadow:
                inset 0 1px 0 rgba(255, 255, 255, 0.18),
                0 16px 34px rgba(3, 20, 47, 0.26);
        }
        ...
        .feature-card::after {
            ...
            height: 8px;
            border-radius: 999px;
            background: rgba(124, 214, 255, 0.7);
            box-shadow: 0 0 0 3px rgba(95, 171, 222, 0.28);
        }
    ...
    <section class="feature-strip" aria-label="Platform highlights">
        <div class="feature-grid">
            <article class="feature-card">
                ...
                <p class="feature-copy">Faculty availability, easy booking, and organized session planning.</p>
            </article>

            <article class="feature-card">
                <div class="feature-icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24">
                        <path d="M21 15a4 4 0 0 1-4 4H9l-4 3v-3a4 4 0 0 1-4-4V9a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v6Z"></path>
                        <path d="M8 10h8"></path>
                        <path d="M8 14h5"></path>
                    </svg>
                </div>
                <h3 class="feature-title">Virtual Consultations</h3>
                <p class="feature-copy">Secure video and chat consultations for academic concerns and follow-ups.</p>
            </article>
            ...
            <article class="feature-card">
                ...
                <p class="feature-copy">View notifications, consultation history, and feedback in one place.</p>
            </article>
        </div>
    </section>
