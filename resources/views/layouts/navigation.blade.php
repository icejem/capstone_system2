...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-0">
            <div class="flex">
                <!-- Left space (logo and primary nav removed as requested) -->
                <div class="shrink-0 flex items-center">
                    <!-- intentionally left blank to keep layout spacing -->
                </div>
            </div>

            <!-- Settings Dropdown (profile removed) -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <!-- Dashboard link removed from responsive nav as requested -->
        </div>
